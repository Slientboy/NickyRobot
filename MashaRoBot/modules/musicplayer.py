...
__help__ = """
 ...
 Assistant name >> ꧁ @Nicky_vc_Assistant꧂
 
<b> Setting up </b>
1) Make bot admin
2) Start a voice chat
3) Try `/play [song name]` for the first time by an admin
*) If userbot joined enjoy music, If not add @Nicky_vc_Assistant to your group and retry
<b> Commands </b>
=>> Song Playing 🎶
...
=>> More tools 📲
  ...
  /userbotjoin: Invite @Nicky_vc_Assistant  Userbot to your chat
